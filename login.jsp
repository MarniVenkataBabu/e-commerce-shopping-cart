			...
			<div class="card-body">
				<form action="user-login" method="post">
					...
					<div class="text-center">
                        ...
                        <button><a href="registration.jsp" color="white">New User Click Here!</a></button><br><br>
                        ...
                        <p class="text-success"><%= message %></p>
                         ...
                         <% String checkoutMessage = (String) request.getSession().getAttribute("checkoutMessage"); %>
