...
<body>
	...
	<div class="container-sm">
		 <div class="card-header my-3"><b>
		 <%if(searchQuery!=null){%><%= searchQuery %> Products</b><%}else if(sidebarCategory!=null){%><%= sidebarCategory%> Products</b><%}else {%><b>All Products</b><%}%></div>
	</div>
	<div class="card-body" style="margin-left: 25%">
        <% 
        if (sidebarCategory != null && sidebarCategory.equals("help")) { %>
            <h1>Contact <b> 7093702308</b> for further assistance.<br>or<br>Email us :<br><b>venkatthekiller@gmail.com</b></h1>
		...
		<div class="row">
			...
			<div class="col-md-3 my-3">
				<div class="card w-100">
					<img class="card-img-top"  height=350 src="product-image/<%=p.getImage() %>"
						alt="Card image cap">
					<div class="card-body">
						<h5 class="card-title"><%=p.getName() %></h5>
						<h6 class="price">Price: &#8377 <%=p.getPrice() %></h6>
